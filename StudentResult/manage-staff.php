                ...
                <table>
                    ...
                    while($res=mysqli_fetch_array($query)){
                        ...
                        <tr>
                            ...
                            <td><?php echo $res['year_of_join'] ?></td>
                            ...
                            <td><a href="del-staff.php?idth=<?php echo $res['id'];?>" data-toggle="tooltip" data-placement="bottom" title="Delete!"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
